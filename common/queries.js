...
const getCharacterGames = (playerCode, page) => `select * from CharacterGames where PlayerCode = CAST(${playerCode} as bigint) order by DateCreated desc offset ${page * 10} rows fetch next 10 rows only;`;
